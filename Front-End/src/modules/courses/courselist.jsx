		   ...
		   <Card className="card-shadow rounded-xl overflow-hidden h-[270px]">
			   <div className="px-4 py-3 border-b border-gray-200 flex items-center justify-between bg-gray-50">
				   ...
				   <button
					   ...
					   className={`text-[11px] font-medium cursor-pointer ${useTheme().theme === 'particles' ? 'particles-viewall' : useTheme().theme === 'retro' ? 'retro-viewall' : 'text-blue-600 hover:text-blue-700'}`}
				   >
					   View All &gt;
				   </button>
			   </div>
